...
class HelloRenderer: NSObject, MTKViewDelegate {
    ...
    public func mtkView(_ view: MTKView, drawableSizeWillChange size: CGSize) {
        reshape(view:view as! HelloMetalView)
    }

    func reshape (view: HelloMetalView) {
    ...
    func update(view: HelloMetalView, drawableSize:CGSize) {
    ...
    public func draw(in view: MTKView) {
        ...
        update(view: view as! HelloMetalView, drawableSize: view.bounds.size)
